        ...
        <div class="form-container">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <!-- <div class="col-12 form-input">
                    ...
                    <input class="form-control" type="text" placeholder="Your Phone Number" id="phone" name="phone">
                </div> -->
                ...
                <div class="col-12 form-input">
                    ...
                    <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" placeholder="Your Password">
                ...
                <div class="col-12">
                    <a><button type="submit" class="submit-btn">Create Account</button></a>
                </div>
