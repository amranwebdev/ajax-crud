...
<section class="main-section">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h1 class="dashboard-title">Welcome Sheehan Bhai! <img src="{{ asset('public/assets/images/hand.png')}}" alt=""
                ...
                <div class="card h-100 subscription-card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="logo-box">
                                    <img src="assets/images/anto-logo-black 1.svg" alt="">
                                </div>
                            </div>
                            <div class="col-12">
                                <h5>Antopolis</h5>
                                <h2>Performance Marketing</h2>
                                <h1>Tk. 50,000/month</h1>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-4 actionBtn">
                                <button><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                        viewBox="0 0 24 24">
                                        <path fill="#EB5757"
                            ...
                            <div class="col-8 text-end">
                                <button class="ligtGrayBtn"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <button class="ligtGrayBtn me-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" fill="none" viewBox="0 0 24 24">
                                        <path fill="#BDBDBD"
